...
test('it renders path data', function(assert) {
  ...
  assert.equal(find('path').getAttribute('d'), 'M1,100C1.3333333333333333,100,1.6666666666666667,100,2,100C2.3333333333333335,100,2.6666666666666665,100,3,100L3,6C2.6666666666666665,11,2.3333333333333335,16,2,16C1.6666666666666667,16,1.3333333333333333,13,1,10Z');
});
